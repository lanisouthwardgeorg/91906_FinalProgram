    ...
    def __init__(self, partner, calc_list):
        ...
        if num_calcs > max_calcs:
            ...
            showing_all = ("Here are your recent calculations ({}/{} calculations are shown). " 
                           ...
                           "history").format(max_calcs, num_calcs) +calc_string_text
            print(".format(max_calcs, num_calcs)".format(max_calcs, num_calcs))
            print(showing_all)

        else:
            print("calculation history")
            calc_background = "#B4FACB"     # pale green
            showing_all = "Below is your calculation history." + calc_string_text
